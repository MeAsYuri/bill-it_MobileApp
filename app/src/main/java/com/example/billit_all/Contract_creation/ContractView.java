...
public class ContractView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signedContract = findViewById(R.id.signedContract);




        signedContract.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ContractView.this, ContractViewing.class);
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                BackendJsonObjectRequest request0 = new BackendJsonObjectRequest(
                                        Request.Method.GET,
                                        "/api/contract/temp-acct/mobile/" + id,
                                        null,
                                        new Response.Listener<JSONObject>() {
                                            @Override
                                            public void onResponse(JSONObject response) {
                                                try {
                                                    ...
                                                    String tenant_name = responseJSON.getString("tenant_name");
...
//                                                                            Log.d("arrayListTNC", String.valueOf(TNC));
                                                                                            ...
                                                                                            String contract = "KNOW ALL MEN BY THESE PRESENTS: This CONTRACT OF LEASE is made and " + "\n" +
                                                                                                    ...
                                                                                                    "in PESOS: RENTFEE , Philippine Currency. All rental " +
                                                                                                    ...
                                                                                                    "P DEPOSITFEE, Philippine Currency wherein the two (2) months " +
...
//        replacing text in the Contract
                                                                                            String modifiedContract = contract
                                                                                                    ...
                                                                                                    .replaceAll("LESSEESIGN", tenant_name);
//                                                                                                    .replaceAll("LESSEE", tenant_name);
