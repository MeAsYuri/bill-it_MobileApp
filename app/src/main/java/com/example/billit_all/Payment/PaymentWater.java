...
import com.example.billit_all.ContractViewing;
...
public class PaymentWater extends AppCompatActivity {
...
//        getSupportActionBar().setDisplayShowTitleEnabled(false);
        ...
        fileName = findViewById(R.id.fileNameWater);
        chooseFile = findViewById(R.id.chooseFileWater);
        uploadPayment = findViewById(R.id.uploadPaymentWater);
        cancelPayment = findViewById(R.id.cancelPaymentWater);
        tenantId = findViewById(R.id.tenantIdWater);
        tenantAmount = findViewById(R.id.amountWater);
...
//        tenantId.setText(String.valueOf(idGet));
        ...
        findViewById(R.id.chooseFileWater).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if ((ContextCompat.checkSelfPermission(getApplicationContext(),
                        Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) && (ContextCompat.checkSelfPermission(getApplicationContext(),
                        Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)) {
                    if ((ActivityCompat.shouldShowRequestPermissionRationale(PaymentWater.this,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE)) && (ActivityCompat.shouldShowRequestPermissionRationale(PaymentWater.this,
                            Manifest.permission.READ_EXTERNAL_STORAGE))) {

                    } else {
                        ActivityCompat.requestPermissions(PaymentWater.this,
        ...
        downloadContract.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PaymentWater.this, "Image Saved Successfully", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(PaymentWater.this, "No Image", Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(PaymentWater.this, "No Image", Toast.LENGTH_SHORT).show();
                }
...
//        tenantId.setText(String.valueOf(idGet));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            {
                Toast.makeText(
                        PaymentWater.this,"no image selected",
    ...
    public void paymentUpload(final Bitmap bitmap) {
        ...
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, "https://bill-it.online/api/paynow/water/" + id,
                new Response.Listener<NetworkResponse>() {
                    @Override
                    public void onResponse(NetworkResponse response) {
//                        Toast.makeText(PaymentWater.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
//                        finish();
                        Dialog dialog = new Dialog(PaymentWater.this);
                        ...
                        btnOkay.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Toast.makeText(PaymentWater.this, "Payment Success", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                                finish();
                            }
                        });
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
//                Toast.makeText(PaymentWater.this, "Error! Please check file", Toast.LENGTH_SHORT).show();
                Toast.makeText(PaymentWater.this, "Payment Success", Toast.LENGTH_SHORT).show();
                finish();
...
//                startActivity(new Intent(PaymentWater.this, ConcernsTenants.class));
//                break;
//            case R.id.settings:
//                startActivity(new Intent(PaymentWater.this, Settings.class));
//                break;
//        }
//
