...
public class Home2FragmentLandlord extends Fragment implements View.OnClickListener {

    ImageView addtenant, settings, notif;
    private WebView mayniladOfficial;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_home2_landlord, container, false);


        mayniladOfficial=(WebView) view.findViewById(R.id.mayniladOfficial);
//        webViewOfficial.setNestedScrollingEnabled(true);
//        webViewOfficial.setLayerType(View.LAYER_TYPE_HARDWARE, null);

        mayniladOfficial.setWebViewClient(new WebViewClient());

        mayniladOfficial.loadUrl("https://www.mayniladwater.com.ph/maynilad-news/");
        WebSettings webSettings=mayniladOfficial.getSettings();
