...
public class ReceiptAdapterTenant2 extends RecyclerView.Adapter<ReceiptAdapterTenant2.myViewHolder> {

    protected ArrayList<Receipt> receipts;
    String billName = "Water";
    File dir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);
    public ReceiptAdapterTenant2(ArrayList<Receipt> receipts){
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.receipt_list_tenant1,parent,false);
...
//                Toast.makeText(myViewHolder.pay_btn.getContext(),"this is payment acitivty",Toast.LENGTH_LONG).show();
                Intent intent = new Intent(myViewHolder.pay_btn.getContext(), PaymentWater.class);
