...
public class OcrActivityTenant3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ocr_tenant3);
        ...
        pd = findViewById(R.id.man_proceed_btn);
        ...
        recognizeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imageUri == null){
                    Toast.makeText(OcrActivityTenant3.this, "Pick an image first", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    pd.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent k = new Intent(OcrActivityTenant3.this, WaterCalculateTenant.class);
        ...
        try{
            ...
            Task<Text> textTaskResult = textRecognizer.process(inputImage).addOnSuccessListener(new OnSuccessListener<Text>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(OcrActivityTenant3.this, "Failed recognizing text"+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }catch (Exception e){
            progressDialog.dismiss();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        //cancelled
                        Toast.makeText(OcrActivityTenant3.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
