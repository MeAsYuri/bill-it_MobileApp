...
public class OcrActivityTenant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recognizeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imageUri == null){
                    Toast.makeText(OcrActivityTenant.this, "Pick an image first", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    pb.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent k = new Intent(OcrActivityTenant.this, ElectricityCalculateTenant.class);
        ...
        try{
            ...
            Task<Text> textTaskResult = textRecognizer.process(inputImage).addOnSuccessListener(new OnSuccessListener<Text>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(OcrActivityTenant.this, "Failed recognizing text"+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }catch (Exception e){
            progressDialog.dismiss();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        //cancelled
                        Toast.makeText(OcrActivityTenant.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
