...
public class OcrActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ocr3);
        ...
        recognizeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imageUri == null){
                    Toast.makeText(OcrActivity3.this, "Pick an image first", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    pd.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent k = new Intent(OcrActivity3.this, CalculateActivity4.class);
        ...
        try{
            ...
            Task<Text> textTaskResult = textRecognizer.process(inputImage).addOnSuccessListener(new OnSuccessListener<Text>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(OcrActivity3.this, "Failed recognizing text"+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }catch (Exception e){
            progressDialog.dismiss();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        //cancelled
                        Toast.makeText(OcrActivity3.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
