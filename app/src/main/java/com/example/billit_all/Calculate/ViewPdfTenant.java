...
public class ViewPdfTenant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_pdf_tenant);
        ...
        conf_Mer_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent g = new Intent(ViewPdfTenant.this, DashboardTenant.class);
                startActivity(g);
                finish();
            }
        });
