...
public class OcrActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recognizeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imageUri == null){
                    Toast.makeText(OcrActivity2.this, "Pick an image first", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    pc.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent k = new Intent(OcrActivity2.this, CalculateActivity3.class);
        ...
        try{
            ...
            Task<Text> textTaskResult = textRecognizer.process(inputImage).addOnSuccessListener(new OnSuccessListener<Text>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(OcrActivity2.this, "Failed recognizing text"+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }catch (Exception e){
            progressDialog.dismiss();
